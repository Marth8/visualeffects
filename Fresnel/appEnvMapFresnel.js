...
import fragmentShaderEnvMapFresnelString from './Shaders/FragmentShaderEnvMapFresnel.js';
...
let envShader = new Shader(vertexShaderString, fragmentShaderEnvMapFresnelString);
let envColor = new Color(envShader, 0.9, 0.1, 0.1);
envColor.ambient = [1, 0.5, 0.31];
envColor.diffuse = [1, 0.5, 0.31];
envColor.specular = [0.5, 0.5, 0.5];
envColor.shininess = 32;
let envCube = new Cube(envShader, false, envColor, null, "e");
...
function animate()
{
    ...
    renderer.drawReflectiveEnvMapElement(envCube, camera, environmentalMap, true, false);
